...
$adminUsername = "XXXXX"; // Set your admin username here
$adminPassword = "XXXXXXXXXXX"; // Set your admin password here

if (isset($_GET['XXXXXXXXXX']) && $_GET['XXXXXXXXXX'] == 1) {
...
#modeToggle:hover {
    ...
    <body>
        <nav>
            ...
            <button id="modeToggle" style="padding:10px;">Dark Mode</button>
        </nav>
        <div class="admin-form">
    ...
    <body>
        ...
        <script>
            function generateCalendar() {
                ...
                let dayCounter = 1;
                const eventDates = <?php echo json_encode(array_column($events, 'event_date')); ?>;
                ...
                for (let i = 0; i < 42; i++) {
                    if (i < firstDayOfMonth || dayCounter > daysInMonth) {
                        ...
                        const currentDateFormatted = `${currentYear}-${paddedMonth}-${paddedDay}`;
                        const isEventDay = eventDatesFormatted.includes(currentDateFormatted);
                        const cellClass = isEventDay ? 'event-date' : '';
